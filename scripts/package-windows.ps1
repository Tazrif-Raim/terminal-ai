...
Write-Host "Windows install URL: $(Join-TerminalAiUrl $BaseUrl '/powershell.ps1')"
Write-Host "Windows uninstall URL: $(Join-TerminalAiUrl $BaseUrl '/uninstall.ps1')"
Write-Host "Linux install URL: $(Join-TerminalAiUrl $BaseUrl '/install.sh')"
Write-Host "Linux uninstall URL: $(Join-TerminalAiUrl $BaseUrl '/uninstall.sh')"
